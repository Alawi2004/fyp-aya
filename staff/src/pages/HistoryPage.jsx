  ...
  return (
    <div style={{ padding: "28px 32px", maxWidth: 1100, margin: "0 auto", fontFamily: "Inter, system-ui, sans-serif" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 16, marginBottom: 24 }}>
        ...
        <SummaryCard label="Total Amount"      value={fmt(totalAmount)}         sub="all time (filtered)" accent />
...
function DetailModal({ record, onClose }) {
  const rows = [
    ...
    ["Balance Before",     fmt(record.balance_before)],
    ["Balance After",      fmt(record.balance_after)],
