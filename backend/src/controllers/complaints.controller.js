...
export const submitComplaint = async (req, res) => {
  ...
  try {
    ...
    const result = await pool
      ...
      .input("tripId", sql.Int, req.body.trip_id || null)
      .input("driverId", sql.Int, req.body.driver_id || null)
      .input("routeId", sql.Int, req.body.route_id || null)
      ...
      .query(`
        INSERT INTO complaints
          (tracking_code, submitted_by_user_id, trip_id, driver_id, route_id, title, description, category, priority)
        OUTPUT INSERTED.complaint_id, INSERTED.tracking_code, INSERTED.status, INSERTED.submitted_at
        VALUES
          (@trackingCode, @submittedBy, @tripId, @driverId, @routeId, @title, @description, @category, @priority)
      `);
